...
The included sample SVG files provide a mix of portrait and landscape ratios until photos are ready. Before publishing, add 20 WebP image pairs and update each data item in `src/lib/gallery/gallery-data.ts` to its matching numbered paths:
